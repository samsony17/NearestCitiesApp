...
def test():
    ...
    db = MySQLdb.connect("myrdbinstance.cf74fqgcehfh.us-west-2.rds.amazonaws.com","supremehc2009","Mobile123","mydbassign4" )
    print("1")
    cursor = db.cursor()
    print("2")
    r_server = redis.Redis("mycachecluster.k4xu2n.0001.usw2.cache.amazonaws.com")
    print("3")
